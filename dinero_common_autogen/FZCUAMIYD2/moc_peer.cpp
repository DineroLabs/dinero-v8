...
template <> constexpr inline auto Peer::qt_create_metaobjectdata<qt_meta_tag_ZN4PeerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'handshakeDone'
        QtMocHelpers::SignalData<void(Peer *)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Signal 'gotMessage'
        QtMocHelpers::SignalData<void(Peer *, QByteArray, QByteArray)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 }, { QMetaType::QByteArray, 6 }, { QMetaType::QByteArray, 7 },
        }}),
        // Signal 'closed'
        QtMocHelpers::SignalData<void(Peer *, QString)>(8, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void Peer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->handshakeDone((*reinterpret_cast< std::add_pointer_t<Peer*>>(_a[1]))); break;
        case 1: _t->gotMessage((*reinterpret_cast< std::add_pointer_t<Peer*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[3]))); break;
        case 2: _t->closed((*reinterpret_cast< std::add_pointer_t<Peer*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        case 3: _t->onReadyRead(); break;
        case 4: _t->onConnected(); break;
        case 5: _t->onError((*reinterpret_cast< std::add_pointer_t<QAbstractSocket::SocketError>>(_a[1]))); break;
        case 6: _t->onPingTick(); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Peer::*)(Peer * )>(_a, &Peer::handshakeDone, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Peer::*)(Peer * , QByteArray , QByteArray )>(_a, &Peer::gotMessage, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Peer::*)(Peer * , QString )>(_a, &Peer::closed, 2))
            return;
    }
}
...
// SIGNAL 0
void Peer::handshakeDone(Peer * _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void Peer::gotMessage(Peer * _t1, QByteArray _t2, QByteArray _t3)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1, _t2, _t3);
}

// SIGNAL 2
void Peer::closed(Peer * _t1, QString _t2)
{
