...
| Height | Files |
|---|---|
| 99,677 (preferred) | [.dat](https://github.com/DineroLabs/dinero-v8/releases/download/v{VERSION}/dinero-assumeutxo-99677-v4.dat) · [manifest](https://github.com/DineroLabs/dinero-v8/releases/download/v{VERSION}/dinero-assumeutxo-99677-v4.manifest.json) · [publisher manifest](https://github.com/DineroLabs/dinero-v8/releases/download/v{VERSION}/dinero-assumeutxo-99677-v4.publisher.manifest.json) · [signature](https://github.com/DineroLabs/dinero-v8/releases/download/v{VERSION}/dinero-assumeutxo-99677-v4.publisher.manifest.sig) |
