...
| Wallet keys, addresses, proving, shield/send/unshield | Staged ZIP32 keys, explicit-network receivers and fresh shield proof construction; spend/unshield, database, operations and live wallet integration not implemented |
