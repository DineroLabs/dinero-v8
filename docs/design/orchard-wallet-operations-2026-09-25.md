...
needs durable address counters and a combined account snapshot, bounded proof
jobs, wallet ownership/selection, live RPC/admission/broadcast, and selected-chain
