...
our %config = (
    ...
    "perlenv" => {
        ...
        "CPP" => undef,
        "CPPDEFINES" => undef,
        "CPPFLAGS" => " -mmacosx-version-min=12.0",
        "CPPINCLUDES" => undef,
        "CROSS_COMPILE" => undef,
        "CXX" => undef,
        "CXXFLAGS" => undef,
...
unless (caller) {
    ...
    use lib '/Users/haydarevich/src/dinero/third_party/openssl-3.3.2/util/perl';
    use OpenSSL::fallback '/Users/haydarevich/src/dinero/third_party/openssl-3.3.2/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/Users/haydarevich/src/dinero/third_party/openssl-3.3.2/Configurations';
        use gentemplate;
