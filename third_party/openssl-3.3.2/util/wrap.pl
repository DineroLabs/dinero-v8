...
BEGIN {
    ...
    require '/Users/haydarevich/src/dinero/third_party/openssl-3.3.2/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/Users/haydarevich/src/dinero/third_party/openssl-3.3.2/test/fips-and-base.cnf';
    shift;
