...
//
// Motto: "Dinero: Real Money For Free People" (timeless, no date)
...
int main(int argc, char** argv) {
    ...
    const uint64_t timestamp = 1772841600;  // 2026-03-07 00:00:00 UTC (Fair Launch v4 — Utreexo fix)
    const uint32_t difficulty = 0x1d31ffce;  // Unified difficulty (50× easier than Bitcoin genesis)
    ...
    std::printf("\n");
    std::printf("╔════════════════════════════════════════════════════════════════════╗\n");
    std::printf("║  DINERO BLOCKHEADER V1 GENESIS MINER (PHASE 3 PREFLIGHT)          ║\n");
    std::printf("╚════════════════════════════════════════════════════════════════════╝\n");
    std::printf("\n");
