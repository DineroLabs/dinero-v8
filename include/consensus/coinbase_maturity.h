 ...
 *
 * Network-specific maturity values:
 * - Mainnet: 100 blocks (standard Bitcoin maturity)
 * - Testnet: 100 blocks (standard Bitcoin maturity)
 * - Regtest: 10 blocks (faster maturity for testing)
 */
class CoinbaseMaturity {
public:
    // Use Params().coinbase_maturity for network-specific value
