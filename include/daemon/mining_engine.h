...
struct WorkTemplate;
struct IEventSink;
namespace dinero { class BlockAssembler; }
...
public:
    ...
    void SetBlockAssembler(dinero::BlockAssembler* assembler) { m_blockAssembler = assembler; }
...
private:
    ...
    dinero::BlockAssembler* m_blockAssembler = nullptr;
    ...
    // Phase 1: Miner instance ID for metrics labels
