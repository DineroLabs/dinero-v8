...
static ChainParams g_mainnet = {
    .name = "mainnet",
    .hrp = "din",
    .magic = 0xD1A0C0DEu,  // Dinero mainnet P2P magic — v7 restart. CANONICAL SOURCE; all callers read via dinero::Params().magic.
...
static ChainParams g_testnet = {
    .name = "testnet",
    .hrp = "tdin",
    .magic = 0xDAB5BFFAu,  // Dinero testnet P2P magic. CANONICAL SOURCE; all callers read via dinero::Params().magic.
...
static ChainParams g_regtest = {
    ...
    .magic = 0xFABFB5DAu,             // Dinero regtest P2P magic. CANONICAL SOURCE; all callers read via dinero::Params().magic.
