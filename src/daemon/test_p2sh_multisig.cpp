...
int main() {
    std::cout << "🚀 Dinero P2SH and Multisig Test" << std::endl;
    std::cout << "=================================" << std::endl;
    
    // Initialize blockchain with datadir
    std::unique_ptr<dinero::Blockchain> blockchain = std::make_unique<dinero::Blockchain>("./test_p2sh_data");
    
    std::cout << "\n1️⃣ Testing Blockchain Initialization..." << std::endl;
    std::cout << "✅ Blockchain initialized with datadir: ./test_p2sh_data" << std::endl;
    ...
    std::cout << "\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" << std::endl;
    std::cout << "🎯 P2SH and Multisig Test COMPLETED!" << std::endl;
    std::cout << "   - Blockchain: ✅ Initialized" << std::endl;
    std::cout << "   - Genesis: ✅ Ready" << std::endl;
    std::cout << "   - Note: P2SH/Multisig methods not yet implemented" << std::endl;
