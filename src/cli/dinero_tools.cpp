...
void showUsage() {
    ...
    std::cout << "  dinero-bech32             - Dinero Bech32 (din1...) ✨\n";
    std::cout << "  bech32                       - Bitcoin Bech32 (bc1...) ✨\n\n";
    std::cout << "Examples:\n";
...
AddressType parseAddressType(const std::string& typeStr) {
    ...
    if (typeStr == "dinero-bech32") return AddressType::BECH32;
    if (typeStr == "bech32") return AddressType::BECH32;
    ...
    if (command == "metadata") {
        ...
        switch (type) {
            ...
            case AddressType::P2SH:
                ...
                break;
            case AddressType::BECH32:
                std::cout << "Dinero/Bitcoin Bech32 (din1.../bc1...)\n";
                break;
            case AddressType::BECH32M:
                std::cout << "Taproot Bech32m (din1.../bc1...)\n";
                break;
        }
